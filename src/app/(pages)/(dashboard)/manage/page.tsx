        ...
        <div className="border-b bg-card">
            <div className="container flex flex-wrap items-center justify-between gap-6 py-8 mx-auto">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage account settings and categories</p>
                </div>
            </div>
        </div>
        {/* END HEADER */}
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center justify-between gap-2">
                        ...
                        <CreateCategoryDialog type={type} onSuccessCallback={() => categoryQuery.refetch()} trigger={
                ...
                <Separator />
                {!dataAvailable ? (<div className="flex h-8 w-full flex-xol items-center justify-center">
    ...
    return(
        <div className="flex border-separate flex-col justify-between rounded-md border shadow-md shadow-black/[0.1] dark:shadow-white/[0.1]">
            ...
            <DeleteCategoryDialog category={category} trigger={(
                <Button className="flex w-full border-separate items-center gap-2 rounded-t-none text-muted-foreground hover:bg-gray-500/30" variant={"secondary"}>
