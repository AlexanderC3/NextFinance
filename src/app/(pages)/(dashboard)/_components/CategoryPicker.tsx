    ...
    <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent className="w-[200px] p-0">
            <Command onSubmit={e => e.preventDefault()}>
                ...
                <CreateCategoryDialog type={type} onSuccessCallback={succesCallback}/>
                <CommandEmpty>
                ...
                <CommandGroup>
                    <CommandList>
                        {categoriesQuery.data && categoriesQuery.data.map((category: Category) => <CommandItem key={category.name} onSelect={() => {
                            setValue(category.name);
                            setOpen((prev) => !prev)
                        }}>
