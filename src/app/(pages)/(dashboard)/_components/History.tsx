                ...
                <CardTitle className="grid grid-flow-row justify-between gap-2 md:grid-flow-col">
                    ...
                    <div className="flex h-10 gap-2">
                        <Badge variant={"outline"} className="flex items-center gap-2 text-sm">
                            <div className="h-4 w-4 rounded-full bg-emerald-500"></div> Income
                        </Badge>
                        <Badge variant={"outline"} className="flex items-center gap-2 text-sm">
...
function TooltipRow({formatter,label,value,bgColor,textColor}: {formatter: Intl.NumberFormat, label: string, value: number, bgColor: string, textColor: string}) {
        ...
        <div className="flex items-center gap-2">
            ...
            <div className="flex w-full justify-between">
                ...
                <div className={cn("text-sm font-bold", textColor)}>
                    <CountUp duration={0.5} preserveValue end={value} decimals={0} formattingFn={formatFn} className="text-sm"/>
                </div>
            </div>
        </div>
    )
